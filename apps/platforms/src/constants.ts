...
export const PLATFORM_CREATOR_ADDRESS = new PublicKey(
  'EPqPP8mSk4bFNfk5cAg9hGR6XPLwh9Rp3Lo4wDiLEdRZ',
)

// Lisprocoin explorer URL - Appears in RecentPlays
export const EXPLORER_URL = 'https://explorer.lisprocoin.so'

// Platform URL - Appears in ShareModal
export const PLATFORM_SHARABLE_URL = 'play.lisprocoin.so'
 ...
 * Make sure the token you want to list has a corresponding pool on https://explorer.lisprocoin.so/pools
...
export const TOS_HTML = `
  ...
  <p><b>10. Lisprocoin Platform:</b> Questo è un servizio fornito da Lisprocoin.</p>
`
